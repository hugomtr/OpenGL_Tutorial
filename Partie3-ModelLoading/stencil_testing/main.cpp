...
int main()
{
    ...
    Shader hilightShader("../shaders/shader.vs", "../shaders/shader_hilight.fs");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        hilightShader.setMat4f("view", glm::value_ptr(view));
        hilightShader.setMat4f("projection", glm::value_ptr(projection));
        glBindTexture(GL_TEXTURE_2D, cubeTexture); 	

        model = glm::translate(model, glm::vec3(-1.0f, 0.001f, -1.0f));
        model = glm::scale(model,glm::vec3(1.1));
        hilightShader.setMat4f("model", glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(2.0f, 0.001f, 0.0f));
        model = glm::scale(model,glm::vec3(1.1));
