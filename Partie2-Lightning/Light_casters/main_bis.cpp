...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 lightPos = glm::vec3(0.5f,0.0f,2.0f);
        glm::vec3 lightColor = glm::vec3(1.0f,1.0f,1.0f);

        cubeShader.use();
        cubeShader.setVec3("cameraPos",glm::value_ptr(camera.Position));
        cubeShader.setVec3("light.position", glm::value_ptr(camera.Position));

        // light properties
        cubeShader.setVec3("light.ambient", glm::value_ptr(glm::vec3(0.2f, 0.2f, 0.2f)));
        cubeShader.setVec3("light.diffuse", glm::value_ptr(glm::vec3(0.5f, 0.5f, 0.5f)));
        ...
        cubeShader.setVec3("light.direction_spot", glm::value_ptr(glm::vec3(0.0f,0.0f,-1.0f)));
        cubeShader.setFloat("light.cutoff", glm::cos(glm::radians(12.5f)));
        cubeShader.setFloat("light.cutoff_big", glm::cos(glm::radians(17.5f)));
        if (index < 100){
            cubeShader.setFloat("light.flash",0.0f);
        } else {
            cubeShader.setFloat("light.flash",1.0f);
        }
